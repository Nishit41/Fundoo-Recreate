        ...
        <div className='main-div' >
            <div className='sub-div1'>
                ...
                <div className='button-div'>
                    ...
                    <Button id='next-button'  onClick={submit} variant="contained">Next</Button>
                </div>
            </div>
            <div className='sub-div2'>
                <img id='image2' src="https://ssl.gstatic.com/accounts/signup/glif/account.svg" />
